    ...
    public function getTabs(): array
    {
        ...
        return [
            ...
            'activas' => Tab::make('Activas')
                ...
                ->badge(static fn () => Reservation::where('status', 'activa')->count())
                ->badgeColor('success')
                ->deferBadge()
            ...
            'entrando_hoy' => Tab::make('Entrando hoy')
                ...
                ->badge(static fn () => Reservation::where('status', 'aprobada')
            ...
            'saliendo_hoy' => Tab::make('Saliendo hoy')
                ...
                ->badge(static fn () => Reservation::where('status', 'activa')
            ...
            'historial' => Tab::make('Historial')
                ...
                ->badge(static fn () => Reservation::whereIn('status', ['checked_out', 'cancelada', 'rechazada'])->count())
                ->badgeColor('gray')
                ->deferBadge()
                ->modifyQueryUsing(fn (Builder $query) =>
                    $query->whereIn('status', ['checked_out', 'cancelada', 'rechazada'])
