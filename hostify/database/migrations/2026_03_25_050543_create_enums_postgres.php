...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("CREATE TYPE payment_method     AS ENUM ('efectivo', 'datafono', 'transferencia')");
        DB::statement("CREATE TYPE invoice_status     AS ENUM ('borrador', 'emitida', 'pagada', 'anulada')");
    }
